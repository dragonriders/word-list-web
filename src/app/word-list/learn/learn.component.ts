...
import { distinctUntilChanged, switchMap, debounceTime, combineAll, map, flatMap } from 'rxjs/operators';
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      ...
      if (this.wordlistsha === '9a304cf0cb4d63718bbf989346ae9b9adf37defa') {
        ...
        if (!this.word.marketlist.length) {
          this.word.fetchMarketList().subscribe(marketlist => {
            this.word.marketlist = marketlist;
